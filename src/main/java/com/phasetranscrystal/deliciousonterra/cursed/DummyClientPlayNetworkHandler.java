...
public class DummyClientPlayNetworkHandler extends ClientPacketListener {
    ...
    static {
        ...
        Registry.register(CURSED_DIMENSION_TYPE_REGISTRY, ResourceLocation.fromNamespaceAndPath("title_screen_mobs", "dummy"), new DimensionType(OptionalLong.of(6000L), true, false, false, true, 1.0, true, false, -64, 384, 384, BlockTags.INFINIBURN_OVERWORLD, BuiltinDimensionTypes.OVERWORLD_EFFECTS, 0.0F, new DimensionType.MonsterSettings(false, true, UniformInt.of(0, 7), 0)));
        ...
        cursedRegistryManager = new RegistryAccess.Frozen() {
            ...
            {
                this.damageTypes = new CursedRegistry(Registries.DAMAGE_TYPE, ResourceLocation.parse("fake_damage"), new DamageType("", DamageScaling.NEVER, 0.0F));
            }

            public Optional<Registry> registry(ResourceKey key) {
                Registry x = (Registry)BuiltInRegistries.REGISTRY.get(key);
                if (x != null) {
